    ...
    <div class="cpanel-items">
        ...
        <div class="item layouts">
			...
			<?php
				...
				$urlajax = JURI::base();
				$urlajax .= 'templates/'.$yt->template.'/includes/cpanel-twidth.php?clayout='.$layouts[$i];
				//echo $urlajax; die();
			?>
            	<li>
                	<input type="radio" 
                    onclick="javascript:onChangelayout('<?php echo $suffixlayout; ?>', 'idSuffix', 'cpanel_twidth', '<?php echo $urlajax ?>')" 
        ...
        <!-- Item: Template width -->
        <div class="item templatewidth" id="cpanel_twidth">
            <h3>Template Widths</h3>
            <div class="field">
                <label>Template Width Type</label>
                <input type="radio" name="ytcpanel_widthType" id="ytcpanel_px_widthtype" class="cp_radio" value="px" <?php echo ($yt->getParam('widthType')=='px')?'checked="checked"':''; ?>/>px&nbsp;
                <input type="radio" name="ytcpanel_widthType" id="ytcpanel_percent_widthtype" class="cp_radio" value="%" <?php echo ($yt->getParam('widthType')=='%')?'checked="checked"':''; ?>/>%
            </div>
            <div class="field">
