...
?>
    ...
    if($this->templateParams->get('thumbnail') == 1){
        if ($img_resize!=''){
        ?>
        <div class="leading-left" style="width:<?php echo $yti->width;?>px">
        <div class="image-content image-leading ifloat<?php echo htmlspecialchars($imgfloat); ?>">
            <?php echo $img_resize; ?>
        </div>
        </div>
        <?php
    ...
    <div class="leading-right<?php echo ($img_resize=='')?' no-leading-left':'';?>">
        ...
        ?>
                <div class="readon-wrap">
                        <a class="readon<?php echo $this->item->params->get('pageclass_sfx'); ?>" href="<?php echo $link; ?>">
...
?>
    ...
    if($this->templateParams->get('thumbnail') == 1){	
        if($img_resize!=''){
        ?>
        <div class="image-content image-intro ifloat<?php echo htmlspecialchars($imgfloat); ?>">
            <?php echo $img_resize; ?>
        </div>
        <?php
        }
